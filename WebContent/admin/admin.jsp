...
<div id="wrapper" style="width: 99%;">
	...
	<td valign="top" colspan="3" class="bb">
		...
		<!-- Be careful what you change.  All changes are made directly to database. -->
		...
		<form id="addAccount" name="addAccount" action="addAccount" method="post">
 		...
 		<!-- action="changePassword" -->
		  <form id="changePassword" name="changePassword" action="changePassword" method="post" onsubmit="return confirmpass(this);">
		  <tr>
